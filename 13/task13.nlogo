...
to go
  ...
  if pos = length chain [
    ...
    if current_iter > iter_n [
      print "Maximum iteration reached."
      stop
    ]
    print (word "Iteration " current_iter " completed. Restarting...")
    restart
  ]
end
...
to load-lsystem-from-file
  ...
  if file-name != "" [
    ...
    while [not file-at-end?] [
      ...
      print (word "Executing : " line)
      run line
    ]
    file-close
    print "The file loaded successfully and is being executed......"
  ]
end
...
to update-chain
  let l n-values (length chain) [ i -> item i chain ]
...
l-system
l-system
"Koch island" "Simple tree" "Hilbert curve" "Dragon curve" "Pythagoras tree"
4
